 ...
 */
export type DataKey = {tag: "Campaign", values: readonly [u64]} | {tag: "Token", values: readonly [u64]} | {tag: "CodeIndex", values: readonly [u64, string]} | {tag: "Delegate", values: readonly [u64, string]} | {tag: "OwnerIndex", values: readonly [string]} | {tag: "Shared", values: readonly [u64, string]} | {tag: "Tally", values: readonly [u64, string, u64]} | {tag: "Settled", values: readonly [u64, string, u64]};
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
        ...
        "",
        ...
        "",
        "",
        "",
        "",
        ...
        "AAAAAAAAAERBdXRob3JpemUgYGRlbGVnYXRlYCB0byByZWRlZW0gY291cG9ucyBvZiBgY2FtcGFpZ25faWRgLiBPd25lciBvbmx5LgAAAAxhZGRfZGVsZWdhdGUAAAADAAAAAAAAAAVvd25lcgAAAAAAABMAAAAAAAAAC2NhbXBhaWduX2lkAAAAAAYAAAAAAAAACGRlbGVnYXRlAAAAEwAAAAEAAAPpAAAD7QAAAAAAAAAD",
        "AAAAAAAAAERMaXN0IHRoZSBjYW1wYWlnbiBJRHMgY3JlYXRlZCBieSBgb3duZXJgLiBQdWJsaWMsIG5vIGF1dGggKEFEUi0wMDgpLgAAAAxjYW1wYWlnbnNfb2YAAAABAAAAAAAAAAVvd25lcgAAAAAAABMAAAABAAAD6gAAAAY=",
        "",
        ...
        "",
        ...
        "",
        ...
        "",
        "AAAAAAAAAEdSZXZva2UgYSBkZWxlZ2F0ZSdzIHJlZGVtcHRpb24gYXV0aG9yaXR5IGZvciBgY2FtcGFpZ25faWRgLiBPd25lciBvbmx5LgAAAAAPcmVtb3ZlX2RlbGVnYXRlAAAAAAMAAAAAAAAABW93bmVyAAAAAAAAEwAAAAAAAAALY2FtcGFpZ25faWQAAAAABgAAAAAAAAAIZGVsZWdhdGUAAAATAAAAAQAAA+kAAAPtAAAAAAAAAAM=",
        ...
        "",
